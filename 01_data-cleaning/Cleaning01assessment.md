...
Mini-project title: Cleaning Level 01

Submission date:1/27/25

Project GitHub subdirectory URL: in cleaning-level-1.qmd file of forked repo
...
2. Did you use LLMs or other AI models to generate text or code for this project? If so, which tools did you use and how did you use them? Remember in this class you *are* allowed (even encouraged) to use these tools for help with coding, but not for writing text. This can be very brief, just one or two sentences is fine unless you have more you'd like to add.
    1. Used ChatGPT to troubleshoot by having it explain error messages and explore solutions.
...
1.  use frequent, informative comments in code and markdown X
2.  find and understand documentation for R packages and functions X
3.  follow a debugging workflow with independent and collaborative strategies X
4.  parse and investigate error messages X
5.  follow a coding style guide X

### RStudio & R

6.  customize RStudio X
...
12. name and differentiate R data types X
13. name and differentiate R objects X
...
In Cleaning Level01, I did every component of 'Troubleshooting, debugging, and best practices', making every effort to track and comment out my code, exploring the various R packages, and debugging in response to error messages, while doing my best to adhere to style guidelines along the way.
Due to the nature of the assignment, I also practiced the conceptual skils of naming and differentiating R data types and objects
...
My main takewaway was to commit and push to github frequently thoughout working on a project rather than just committing once at the end. Even for a relatively "short" exercise like Cleaning-01, it is wise to take advantage of the version control software. Because even the most straightforward-seeming project can (and usually will) require a fair amount of debugging. So what once might hope will be a quick assignment often takes a lot longer.
